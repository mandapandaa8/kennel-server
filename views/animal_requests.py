...
del_key_customer = "customerId"

for items in ANIMALS:
    if del_key_customer in items:
        del items[del_key_customer]

del_key_location = "locationId"

for items in ANIMALS:
    if del_key_location in items:
        del items[del_key_location]